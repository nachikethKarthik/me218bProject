...
typedef enum
{
  InitPState, TestState, LineFollowingState_1, LineFollowingState_2, LineFollowingState_3, LineFollowingState_4,LineFollowingState_5,LineFollowingState_6, CheckPoint3State_1, CheckPoint3State_2
}LeaderState_t;
